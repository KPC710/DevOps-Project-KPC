...
module "rds_db_instance" {
  ...
  subnet_groups        = tolist(module.networking.dev_proj_1_public_subnets) #it should be always private subnet for time being we used public subnet
